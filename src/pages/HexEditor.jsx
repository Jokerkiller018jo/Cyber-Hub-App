...
export default function HexEditor() {
    ...
    const handleHexChange = (idx, newHex) => {
        const newLines = [...hexLines];
        newLines[idx].hex = newHex;
                    ...
                    <div className="card" style={{ flex: 1, overflowY: 'auto', fontFamily: '"JetBrains Mono", monospace', fontSize: '0.85rem' }}>
                        ...
                        {hexLines.map((line, idx) => (
                            <div key={idx} style={{ display: 'flex', marginBottom: '4px' }}>
                                ...
                                <input 
                                    style={{ flex: 1, color: 'var(--text-main)', letterSpacing: '1px', background: 'transparent', border: 'none', outline: 'none', fontFamily: 'inherit', fontSize: 'inherit' }} 
                                    value={line.hex}

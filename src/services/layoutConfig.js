...
export const DEFAULT_NAV_ITEMS = [
    ...
    { id: 'color-history',  path: '/color-history',  name: 'COLOR HISTORY', icon: 'eyedropper', desc: 'Picking color history & eyedropper' },
];
...
export const DEFAULT_LAYOUT = {
    ...
    navOrder: ['lobby', 'market', 'currencies', 'symbols', 'color-history'],
